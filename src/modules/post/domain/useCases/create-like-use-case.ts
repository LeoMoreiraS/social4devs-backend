...
export class CreateLikeUseCase {
  ...
  async execute({ postEmail, userEmail, postBody }: CreateLikeDTO.Params): Promise<void> {
    ...
    this.likeRepository.create({ postEmail, userEmail, postBody });
  }
}
